...
__attribute__((section (".AXI_SRAM"), aligned(32))) uint16_t adc1_buffer[8192 +4] ;
__attribute__((section (".AXI_SRAM"), aligned(32))) uint16_t adc2_buffer[8192] ;
...
__attribute__((section (".AXI_SRAM"), aligned(32))) uint16_t phase_adc_buffer[16] ;
