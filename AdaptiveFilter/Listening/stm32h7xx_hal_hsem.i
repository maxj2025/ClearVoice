...
# 177 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_hsem.c"
  ((HSEM_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x6400UL))->R[SemID] = (ProcessID | ((0x00000003UL) << (8U)) | (0x1UL << (31U)));


  if (((HSEM_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x6400UL))->R[SemID] == (ProcessID | ((0x00000003UL) << (8U)) | (0x1UL << (31U))))
  {
...
# 210 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_hsem.c"
  if (((HSEM_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x6400UL))->RLR[SemID] == (((0x00000003UL) << (8U)) | (0x1UL << (31U))))
  {
...
void HAL_HSEM_Release(uint32_t SemID, uint32_t ProcessID)
{
  ...
  ((HSEM_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x6400UL))->R[SemID] = (ProcessID | ((0x00000003UL) << (8U)));
