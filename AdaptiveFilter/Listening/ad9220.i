...
void AD9220_Stop_DMA(void)
{
    ...
    do { if (((&htim2)->Instance->CCER & ((uint32_t)((0x1UL << (0U)) | (0x1UL << (4U)) | (0x1UL << (8U)) | (0x1UL << (12U)) | (0x1UL << (16U)) | (0x1UL << (20U))))) == 0UL) { if(((&htim2)->Instance->CCER & ((uint32_t)((0x1UL << (2U)) | (0x1UL << (6U)) | (0x1UL << (10U))))) == 0UL) { (&htim2)->Instance->CR1 &= ~((0x1UL << (0U))); } } } while(0);
