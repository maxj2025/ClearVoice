...
# 86 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c" 2
...
HAL_StatusTypeDef HAL_FLASHEx_ComputeCRC(FLASH_CRCInitTypeDef *pCRCInit, uint32_t *CRC_Result)
{
  ...
  if (status == HAL_OK)
  {
    if (pCRCInit->Bank == 0x01U)
    {
      ...
      ((FLASH_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x2000UL))->CRCCR1 &= ~((0x3UL << (20U)) | (0x1UL << (22U)));
    ...
    else
    {
      ...
      ((FLASH_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x2000UL))->CRCCR2 &= ~((0x3UL << (20U)) | (0x1UL << (22U)));
...
# 1444 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c"
static void FLASH_OB_UserConfig(uint32_t UserType, uint32_t UserConfig)
{
...
# 1611 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c"
...
# 1632 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c"
static uint32_t FLASH_OB_GetUser(void)
{
...
# 1666 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c"
...
# 1905 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c"
static void FLASH_OB_SecureAreaConfig(uint32_t SecureAreaConfig, uint32_t SecureAreaStartAddr, uint32_t SecureAreaEndAddr, uint32_t Banks)
{
...
# 2012 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c"
static void FLASH_CRC_SelectAddress(uint32_t CRCStartAddr, uint32_t CRCEndAddr, uint32_t Bank)
{
  if (Bank == 0x01U)
  {
